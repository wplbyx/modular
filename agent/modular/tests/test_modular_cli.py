...
class ModularCliTest(unittest.TestCase):
    ...
    def test_service_requires_explicit_transport_and_creates_no_business_shells(self) -> None:
        ...
        self.assertFalse((project / "cmd/demo/modules.go").read_text(encoding="utf-8").find("httpserver") >= 0)
    ...
    def test_generated_config_uses_named_pascal_case_application(self) -> None:
        ...
        command = (project / "cmd/namedconfig/main.go").read_text(encoding="utf-8")
    ...
    def test_managed_conflicts_stop_before_any_write(self) -> None:
        ...
        before_cmd = (project / "cmd/demo/main.go").read_bytes()
        ...
        self.assertEqual(before_cmd, (project / "cmd/demo/main.go").read_bytes())
    ...
    def test_post_write_verification_failure_rolls_back_transaction(self) -> None:
        project = self.init_project()
        business = project / "cmd/demo/business.go"
        ...
        self.assertNotIn("User", (project / "cmd/demo/main.go").read_text(encoding="utf-8"))
    ...
    def test_resource_wiring_uses_selected_library_resources_only(self) -> None:
        ...
        cmd = (project / "cmd/demo/main.go").read_text(encoding="utf-8")
