...
| DB/Redis/Storage/Telemetry | [resource](references/workflows/resource.md) | `resource add/remove` |
...
1. **Framework** creates a compiling topology, config, cmd, explicitly selected
   ...
   seam. It does not create business packages or fake repositories.
